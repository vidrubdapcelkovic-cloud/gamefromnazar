/**
 * Deterministic preparation of assets/generated/electricman.png.
 *
...
const TARGET_RELATIVE = 'assets/generated/electricman.png';
...
function prepareElectricmanAsset() {
  ...
  const tempPath = path.join(
    ...
    `.electricman-prep-tmp-${process.pid}-${Date.now()}.png`
  );
...
if (require.main === module) {
  const result = prepareElectricmanAsset();
  console.log('prepare-electricman-asset: ok');
