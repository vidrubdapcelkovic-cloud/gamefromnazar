/**
 * Deterministic preparation of assets/generated/bowman.png.
 *
...
const TARGET_RELATIVE = 'assets/generated/bowman.png';
...
function prepareBowmanAsset() {
  ...
  const tempPath = path.join(
    ...
    `.bowman-prep-tmp-${process.pid}-${Date.now()}.png`
  );
...
if (require.main === module) {
  const result = prepareBowmanAsset();
  console.log('prepare-bowman-asset: ok');
