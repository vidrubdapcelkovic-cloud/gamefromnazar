/**
 * Deterministic preparation of assets/generated/tall-monster.png.
 *
...
const TARGET_RELATIVE = 'assets/generated/tall-monster.png';
...
function prepareTallMonsterAsset() {
  ...
  const tempPath = path.join(
    ...
    `.tall-monster-prep-tmp-${process.pid}-${Date.now()}.png`
  );
...
if (require.main === module) {
  const result = prepareTallMonsterAsset();
  console.log('prepare-tall-monster-asset: ok');
